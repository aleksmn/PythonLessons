...
# из 13 номиналов (от 2 до 10, валет (В), дама (Д), король (К) и туз (Т)).
...
# 2 до 10, В, Д, К или Т), а второй – на масть (п = пики,
# ч = червы, б = бубны и т = трефы)
# Примеры карт: Тч, 9б, Дп
...
# Напишите алгоритм, который будет принимать на вход целочисленный массив и возвращать максимальную сумму подмассива в этом массиве. Например, для массива [-2, 1, -3, 4, -1, 2, 1, -5, 4] ответом будет являться 6, так как максимальная сумма подмассива [4, -1, 2, 1] равна 6.

# Убедитесь, что ваше решение работает для массивов произвольной длины и содержащих любые целочисленные значения (включая отрицательные числа).